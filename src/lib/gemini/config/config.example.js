export const CONFIG = {
    ...
    SYSTEM_INSTRUCTION: {
        TEXT: 'You are my helpful assistant. You can hear me, and respond with voice and text. If you are asked about things you do not know, you can use the google search tool to find the answer.',
    },
    // Model's voice
    VOICE: {
